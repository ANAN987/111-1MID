...
<body>
    <form id="form1" runat="server">
        <div>   
           ...
           <h3> <asp:Label  ID="1b_type" runat="server"Text="初診" ></asp:Label></h3>
              ...
              <asp:Label ID="Labal1" runat="server" Text="連絡電話:(選填)"></asp:Label>
            ...
            <asp:Label ID="1b_Msg" runat="server" Text=""></asp:Label>
            <asp:HyperLink ID="HyperLink" runat="server" NavigateUrl="~/Q1.aspx" Text="重新填寫"></asp:HyperLink>
          </asp:Panel>
